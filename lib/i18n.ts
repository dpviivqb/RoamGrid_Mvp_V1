...
const dictionary = {
  en: {
    ...
    adminAreaUnsupported: "This area is not supported yet. Your route is tracked, but blocks are not counted.",
    adminAreaLoadFailed: "Failed to load administrative boundary data.",
    ...
    locationRetrying: "Position is temporarily unavailable. Retrying...",
    ...
    pathExtendedBody: "No new blocks this run, but your route earned {xp} XP in {place}.",
    ...
    remoteHistorySyncFailed: "Remote history unavailable: {error}",
  ...
  zh: {
    ...
    adminAreaUnsupported: "当前区域暂未支持。路线会继续记录，但不会累计区块。",
    adminAreaLoadFailed: "行政区边界数据加载失败。",
    ...
    locationRetrying: "暂时无法获取定位，正在重试...",
    retryLocation: "重试定位",
    noPoints: "还没有记录到定位点。",
    ...
    pathExtended: "路径已延展",
    pathExtendedBody: "本次没有新区块，但你在 {place} 的轨迹获得了 {xp} XP。",
    progress: "{place} 探索进度",
    ...
    remoteHistorySyncFailed: "远端历史暂不可用：{error}",
    shareDistance: "距离",
    shareTime: "时长",
    shareExplored: "已探索",
